      ...
      <CSSTransition in={this.state.show} timeout={300} classNames="translate">
        <div className="music-album">
          ...
          <div style={{ position: "relative" }}>
            <div ref={(el) => { this.albumBgDOM = el; }} className="album-img" style={imgStyle}>
              <div className="filter"></div>
            </div>
            <div ref={(el) => { this.albumFixedBgDOM = el; }} className="album-img fixed" style={imgStyle}>
              <div className="filter"></div>
            </div>
          ...
          <div ref={(el) => { this.albumContainerDOM = el; }} className="album-container">
              ...
              <Scroll refresh={this.state.refreshScroll} onScroll={this.scroll}>
                <div className="album-wrapper skin-detail-wrapper">
                  ...
                  <div className="album-info" style={album.desc ? {} : { display: "none" }}>
                    ...
                    <div className="album-desc" dangerouslySetInnerHTML={{__html: album.desc}}>
                    </div>
                  </div>
                </div>
              </Scroll>
